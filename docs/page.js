...
if (btn1) {
    btn1.addEventListener("click", () => { // This adds an event listener to the button that listens for a "click" event from the mouse, and executes the function when the button is clicked
        btn1.textContent = "You Clicked Me!"; // This changes the text content of the button to something else when it is clicked using btn1 for the variable and textContent to change the text
        alert("You clicked the button!"); // A default page alert that can pop up
    });
}
