...
List<String> list = ["hello", "world", "dart", "google"] // This is an array with only strings. Change "strings" to another data type for specified items
print(list[0]) // Prints the first item (1st index count, generically 0)
